...
class ArtistActivity : BaseActivity<ArtistLayout>(), ArtistView, AlbumsFragmentContainer {
    ...
    private fun setUpViewPager() {
        ...
        artistDetailPagerAdapter.addFragment(
            biographyFragment, resources.getString(R.string.bio_fragment_title))
        artistDetailPagerAdapter.addFragment(
            albumsFragment, resources.getString(R.string.albums_fragment_title))
    ...
    override fun showArtist(artistDetail: ArtistDetail) {
        picasso.load(artistDetail.url).fit().centerCrop().into(ui.image) {
    ...
    override fun getAlbumsPresenter(): AlbumsPresenter = presenter
}
